...
# ==================================================
# LOAD EPG CHANNEL (BERDASAR NAMA)
# ==================================================
...
# ==================================================
# LOAD PROGRAMME (LIVE + NEXT SEPAK BOLA) – SAFE
# ==================================================
...
with open(EPG_FILE, encoding="utf-8", errors="ignore") as f:
    ...
    for line in f:
        ...
        elif "<desc>" in line and "title" not in cur:
            ...
            if title:
                ...
                if any(k in text for k in BOLA_KEYS):
                    ...
                    if cur["start"] <= NOW <= cur["stop"]:
                        live_event[cid] = (title, cur["start"])

                    # 🟡 NEXT (ambil terdekat)
                    elif cur["start"] > NOW:
                        if cid not in next_event or cur["start"] < next_event[cid][1]:
                            next_event[cid] = (title, cur["start"])

            cur = {}

# ==================================================
# MATCH EPG BERDASAR NAMA CHANNEL
# ==================================================
...
print("DONE ✅ LIVE + NEXT rename WIB (SAFE)")
